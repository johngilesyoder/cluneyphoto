      ...
      <footer class="site-footer" role="contentinfo">
        <div class="container-fluid">
          ...
          <ul class="footer-social">
            ...
            <li><a target="_blank" href="http://facebook.com/cluneyphoto"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/icon-facebook.png" alt="Find us on Facebook"></a></li>
            <li><a target="_blank" href="http://instagram.com/cluneyphoto"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/icon-instagram-1.png" alt="Follow us on Instagram"></a></li>
          </ul>
